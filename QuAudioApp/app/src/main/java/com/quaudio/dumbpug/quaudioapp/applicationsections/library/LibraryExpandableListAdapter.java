...
public class LibraryExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    LibraryExpandableListAdapter(QuAppActivity currentActivity, ArrayList<LocalTrackGroup> trackList) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        LocalTrack track = (LocalTrack) getChild(groupPosition, childPosition);
